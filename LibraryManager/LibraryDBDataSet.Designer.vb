...
Partial Public Class LibraryDBDataSet
    ...
    Partial Public Class BooksDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddBooksRow(ByVal Name As String, ByVal Author As String, ByVal Publisher As String, ByVal DatePublished As Date, ByVal Pages As Integer, ByVal Rating As Double) As BooksRow
            Dim rowBooksRow As BooksRow = CType(Me.NewRow,BooksRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, Author, Publisher, DatePublished, Pages, Rating}
    ...
    Partial Public Class BooksRow
        ...
        Public Property DatePublished() As Date
            Get
                Try 
                    Return CType(Me(Me.tableBooks.DatePublishedColumn),Date)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'DatePublished' in table 'Books' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableBooks.DatePublishedColumn) = value
            End Set
        End Property
        ...
        Public Property Pages() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableBooks.PagesColumn),Integer)
                Catch e As Global.System.InvalidCastException
        ...
        Public Function IsDatePublishedNull() As Boolean
            Return Me.IsNull(Me.tableBooks.DatePublishedColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetDatePublishedNull()
            Me(Me.tableBooks.DatePublishedColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IsRatingNull() As Boolean
            Return Me.IsNull(Me.tableBooks.RatingColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetRatingNull()
            Me(Me.tableBooks.RatingColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace LibraryDBDataSetTableAdapters
    ...
    Partial Public Class BooksTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([BookID] = @Original_BookID) AND ((@IsNull_Name"& _ 
                " = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Author = 1 "& _ 
                ...
                "ll_DatePublished = 1 AND [DatePublished] IS NULL) OR ([DatePublished] = @Origina"& _ 
                "l_DatePublished)) AND ((@IsNull_Pages = 1 AND [Pages] IS NULL) OR ([Pages] = @Or"& _ 
                "iginal_Pages)) AND ((@IsNull_Rating = 1 AND [Rating] IS NULL) OR ([Rating] = @Or"& _ 
                "iginal_Rating)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_DatePublished", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DatePublished", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Name], [Author], [Publisher], [DatePublished], [Pages"& _ 
                "], [Rating]) VALUES (@Name, @Author, @Publisher, @DatePublished, @Pages, @Rating"& _ 
                ");"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT BookID, Name, Author, Publisher, DatePublished, Pages, Rating FROM Bo"& _ 
                "oks WHERE (BookID = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DatePublished", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DatePublished", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [Name] = @Name, [Author] = @Author, [Publisher] = @Publi"& _ 
                "sher, [DatePublished] = @DatePublished, [Pages] = @Pages, [Rating] = @Rating WHE"& _ 
                "RE (([BookID] = @Original_BookID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR "& _ 
                "([Name] = @Original_Name)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([A"& _ 
                "uthor] = @Original_Author)) AND ((@IsNull_Publisher = 1 AND [Publisher] IS NULL)"& _ 
                " OR ([Publisher] = @Original_Publisher)) AND ((@IsNull_DatePublished = 1 AND [Da"& _ 
                "tePublished] IS NULL) OR ([DatePublished] = @Original_DatePublished)) AND ((@IsN"& _ 
                "ull_Pages = 1 AND [Pages] IS NULL) OR ([Pages] = @Original_Pages)) AND ((@IsNull"& _ 
                "_Rating = 1 AND [Rating] IS NULL) OR ([Rating] = @Original_Rating)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Bo"& _ 
                "okID, Name, Author, Publisher, DatePublished, Pages, Rating FROM Books WHERE (Bo"& _ 
                "okID = @BookID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DatePublished", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DatePublished", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_DatePublished", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "DatePublished", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.LibraryManager.My.MySettings.Default.LibraryDBConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT BookID, Name, Author, Publisher, DatePublished, Pages, Rating FROM dbo.Boo"& _ 
                "ks"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_BookID As Integer, ByVal Original_Name As String, ByVal Original_Author As String, ByVal Original_Publisher As String, ByVal Original_DatePublished As Global.System.Nullable(Of Date), ByVal Original_Pages As Global.System.Nullable(Of Integer), ByVal Original_Rating As Global.System.Nullable(Of Double)) As Integer
            ...
            If (Original_DatePublished.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_DatePublished.Value,Date)
            Else
            ...
            If (Original_Rating.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(12).Value = CType(Original_Rating.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Author As String, ByVal Publisher As String, ByVal DatePublished As Global.System.Nullable(Of Date), ByVal Pages As Global.System.Nullable(Of Integer), ByVal Rating As Global.System.Nullable(Of Double)) As Integer
            ...
            If (Pages.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(Pages.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Author As String, ByVal Publisher As String, ByVal DatePublished As Global.System.Nullable(Of Date), ByVal Pages As Global.System.Nullable(Of Integer), ByVal Rating As Global.System.Nullable(Of Double), ByVal Original_BookID As Integer, ByVal Original_Name As String, ByVal Original_Author As String, ByVal Original_Publisher As String, ByVal Original_DatePublished As Global.System.Nullable(Of Date), ByVal Original_Pages As Global.System.Nullable(Of Integer), ByVal Original_Rating As Global.System.Nullable(Of Double), ByVal BookID As Integer) As Integer
            If (Name Is Nothing) Then
            ...
            End If
            If (Pages.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Pages.Value,Integer)
            Else
            ...
            If (Original_DatePublished.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_DatePublished.Value,Date)
            Else
            ...
            If (Original_Rating.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(Original_Rating.Value,Double)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Author As String, ByVal Publisher As String, ByVal DatePublished As Global.System.Nullable(Of Date), ByVal Pages As Global.System.Nullable(Of Integer), ByVal Rating As Global.System.Nullable(Of Double), ByVal Original_BookID As Integer, ByVal Original_Name As String, ByVal Original_Author As String, ByVal Original_Publisher As String, ByVal Original_DatePublished As Global.System.Nullable(Of Date), ByVal Original_Pages As Global.System.Nullable(Of Integer), ByVal Original_Rating As Global.System.Nullable(Of Double)) As Integer
            Return Me.Update(Name, Author, Publisher, DatePublished, Pages, Rating, Original_BookID, Original_Name, Original_Author, Original_Publisher, Original_DatePublished, Original_Pages, Original_Rating, Original_BookID)
        End Function
    End Class
